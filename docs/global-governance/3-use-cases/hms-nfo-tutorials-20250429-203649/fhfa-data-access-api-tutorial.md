# Using Data Access API with Federal Housing Finance Agency

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Housing Finance Agency's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fhfa')
```
...
plt.title('Federal Housing Finance Agency Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
