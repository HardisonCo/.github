# Using Internet Data Collection System with Export-Import Bank of the United States

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support Export-Import Bank of the United States's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='exim')
```
