# Using Data Access API with Commodity Futures Trading Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Commodity Futures Trading Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='cftc')
```
...
plt.title('Commodity Futures Trading Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Commodity Futures Trading Commission Data Integration Guide](../agencies/cftc.md)
