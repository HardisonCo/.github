# Using Moneyball Analytics Framework with United States International Trade Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Moneyball Analytics Framework to support United States International Trade Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('moneyball_analytics_framework', agency='usitc')
```
