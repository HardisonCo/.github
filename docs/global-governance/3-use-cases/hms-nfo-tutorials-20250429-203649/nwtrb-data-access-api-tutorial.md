# Using Data Access API with Nuclear Waste Technical Review Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Nuclear Waste Technical Review Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='nwtrb')
```
...
plt.title('Nuclear Waste Technical Review Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Nuclear Waste Technical Review Board Data Integration Guide](../agencies/nwtrb.md)
