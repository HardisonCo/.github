# Using Data Access API with National Endowment for the Arts

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support National Endowment for the Arts's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='nea')
```
...
plt.title('National Endowment for the Arts Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [National Endowment for the Arts Data Integration Guide](../agencies/nea.md)
