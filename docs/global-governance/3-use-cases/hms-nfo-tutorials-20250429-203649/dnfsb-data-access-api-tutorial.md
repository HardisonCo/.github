# Using Data Access API with Defense Nuclear Facilities Safety Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Defense Nuclear Facilities Safety Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='dnfsb')
```
...
plt.title('Defense Nuclear Facilities Safety Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Defense Nuclear Facilities Safety Board Data Integration Guide](../agencies/dnfsb.md)
