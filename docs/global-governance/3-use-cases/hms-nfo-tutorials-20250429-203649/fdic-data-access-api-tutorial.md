# Using Data Access API with Federal Deposit Insurance Corporation

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Deposit Insurance Corporation's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fdic')
```
...
plt.title('Federal Deposit Insurance Corporation Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Federal Deposit Insurance Corporation Data Integration Guide](../agencies/fdic.md)
