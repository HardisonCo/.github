# Using Internet Data Collection System with National Transportation Safety Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support National Transportation Safety Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='ntsb')
```
