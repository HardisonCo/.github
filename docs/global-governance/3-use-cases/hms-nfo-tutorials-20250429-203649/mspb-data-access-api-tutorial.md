# Using Data Access API with Merit Systems Protection Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Merit Systems Protection Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='mspb')
```
...
plt.title('Merit Systems Protection Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Merit Systems Protection Board Data Integration Guide](../agencies/mspb.md)
