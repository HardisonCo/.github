# Using Data Access API with Securities and Exchange Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Securities and Exchange Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='sec')
```
...
plt.title('Securities and Exchange Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Securities and Exchange Commission Data Integration Guide](../agencies/sec.md)
