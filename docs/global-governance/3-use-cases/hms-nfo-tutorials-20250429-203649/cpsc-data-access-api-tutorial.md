# Using Data Access API with Consumer Product Safety Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Consumer Product Safety Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='cpsc')
```
...
plt.title('Consumer Product Safety Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Consumer Product Safety Commission Data Integration Guide](../agencies/cpsc.md)
