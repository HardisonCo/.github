# Using Data Access API with National Transportation Safety Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support National Transportation Safety Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ntsb')
```
...
plt.title('National Transportation Safety Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [National Transportation Safety Board Data Integration Guide](../agencies/ntsb.md)
