# Using Data Access API with Social Security Advisory Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Social Security Advisory Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ssab')
```
...
plt.title('Social Security Advisory Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Social Security Advisory Board Data Integration Guide](../agencies/ssab.md)
