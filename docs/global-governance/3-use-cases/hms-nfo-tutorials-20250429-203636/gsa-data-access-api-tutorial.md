# Using Data Access API with General Services Administration

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support General Services Administration's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='gsa')
```
...
plt.title('General Services Administration Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [General Services Administration Data Integration Guide](../agencies/gsa.md)
