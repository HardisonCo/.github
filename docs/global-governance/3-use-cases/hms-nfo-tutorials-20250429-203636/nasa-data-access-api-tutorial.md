# Using Data Access API with National Aeronautics and Space Administration

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support National Aeronautics and Space Administration's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='nasa')
```
...
plt.title('National Aeronautics and Space Administration Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [National Aeronautics and Space Administration Data Integration Guide](../agencies/nasa.md)
