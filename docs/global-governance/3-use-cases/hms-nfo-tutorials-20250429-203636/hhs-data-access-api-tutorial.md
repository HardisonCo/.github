# Using Data Access API with Department of Health and Human Services

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Department of Health and Human Services's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='hhs')
```
...
plt.title('Department of Health and Human Services Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Department of Health and Human Services Data Integration Guide](../agencies/hhs.md)
