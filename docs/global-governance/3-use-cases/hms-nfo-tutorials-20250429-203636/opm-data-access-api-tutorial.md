# Using Data Access API with Office of Personnel Management

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Office of Personnel Management's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='opm')
```
...
plt.title('Office of Personnel Management Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Office of Personnel Management Data Integration Guide](../agencies/opm.md)
