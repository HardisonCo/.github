# Using Learning System with U.S. Agency for International Development

## Overview

This tutorial demonstrates how to use the HMS-NFO Learning System to support U.S. Agency for International Development's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('learning_system', agency='usaid')
```
