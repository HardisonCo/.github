# Using Data Access API with Office of Government Ethics

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Office of Government Ethics's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='oge')
```
...
plt.title('Office of Government Ethics Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
