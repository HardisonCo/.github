# Using Data Access API with National Council on Disability

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support National Council on Disability's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ncd')
```
...
plt.title('National Council on Disability Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [National Council on Disability Data Integration Guide](../agencies/ncd.md)
