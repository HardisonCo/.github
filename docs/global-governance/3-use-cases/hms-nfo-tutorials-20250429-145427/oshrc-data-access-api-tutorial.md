# Using Data Access API with Occupational Safety and Health Review Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Occupational Safety and Health Review Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='oshrc')
```
...
plt.title('Occupational Safety and Health Review Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
