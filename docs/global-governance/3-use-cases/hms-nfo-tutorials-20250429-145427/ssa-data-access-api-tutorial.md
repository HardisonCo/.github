# Using Data Access API with Social Security Administration

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Social Security Administration's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ssa')
```
...
plt.title('Social Security Administration Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Social Security Administration Data Integration Guide](../agencies/ssa.md)
