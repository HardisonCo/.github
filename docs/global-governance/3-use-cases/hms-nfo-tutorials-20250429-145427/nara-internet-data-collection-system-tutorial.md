# Using Internet Data Collection System with National Archives and Records Administration

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support National Archives and Records Administration's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='nara')
```
