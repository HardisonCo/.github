# Using Moneyball Analytics Framework with U.S. Agency for International Development

## Overview

This tutorial demonstrates how to use the HMS-NFO Moneyball Analytics Framework to support U.S. Agency for International Development's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('moneyball_analytics_framework', agency='usaid')
```
...
- [U.S. Agency for International Development Data Integration Guide](../agencies/usaid.md)
