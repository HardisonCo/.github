# Using Data Access API with United States Commission on Civil Rights

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support United States Commission on Civil Rights's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ccr')
```
...
plt.title('United States Commission on Civil Rights Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [United States Commission on Civil Rights Data Integration Guide](../agencies/ccr.md)
