# Using Internet Data Collection System with United States International Trade Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support United States International Trade Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='usitc')
```
...
- [United States International Trade Commission Data Integration Guide](../agencies/usitc.md)
