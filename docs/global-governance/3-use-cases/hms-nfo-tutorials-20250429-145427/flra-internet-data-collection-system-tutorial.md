# Using Internet Data Collection System with Federal Labor Relations Authority

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support Federal Labor Relations Authority's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='flra')
```
