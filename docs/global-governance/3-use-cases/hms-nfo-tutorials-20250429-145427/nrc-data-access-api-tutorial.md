# Using Data Access API with Nuclear Regulatory Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Nuclear Regulatory Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='nrc')
```
...
plt.title('Nuclear Regulatory Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Nuclear Regulatory Commission Data Integration Guide](../agencies/nrc.md)
