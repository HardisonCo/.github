# Using Data Access API with Export-Import Bank of the United States

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Export-Import Bank of the United States's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='exim')
```
...
plt.title('Export-Import Bank of the United States Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Export-Import Bank of the United States Data Integration Guide](../agencies/exim.md)
