# Using Data Access API with Federal Election Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Election Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fec')
```
...
plt.title('Federal Election Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Federal Election Commission Data Integration Guide](../agencies/fec.md)
