# Using Knowledge Integration Engine with FTC

## Overview

This tutorial demonstrates how to use HMS-NFO's Knowledge Integration Engine to enhance FTC's data capabilities and decision-making processes.
