# Using Knowledge Integration Engine with SEC

## Overview

This tutorial demonstrates how to use HMS-NFO's Knowledge Integration Engine to enhance SEC's data capabilities and decision-making processes.
