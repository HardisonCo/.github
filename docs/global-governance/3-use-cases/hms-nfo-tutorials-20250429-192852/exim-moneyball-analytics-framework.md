# Using Moneyball Analytics Framework with EXIM

## Overview

This tutorial demonstrates how to use HMS-NFO's Moneyball Analytics Framework to enhance EXIM's data capabilities and decision-making processes.
