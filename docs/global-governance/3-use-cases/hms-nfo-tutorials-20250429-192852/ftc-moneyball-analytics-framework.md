# Using Moneyball Analytics Framework with FTC

## Overview

This tutorial demonstrates how to use HMS-NFO's Moneyball Analytics Framework to enhance FTC's data capabilities and decision-making processes.
