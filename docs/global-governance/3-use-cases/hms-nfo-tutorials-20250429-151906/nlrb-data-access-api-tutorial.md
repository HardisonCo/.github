# Using Data Access API with National Labor Relations Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support National Labor Relations Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='nlrb')
```
...
plt.title('National Labor Relations Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [National Labor Relations Board Data Integration Guide](../agencies/nlrb.md)
