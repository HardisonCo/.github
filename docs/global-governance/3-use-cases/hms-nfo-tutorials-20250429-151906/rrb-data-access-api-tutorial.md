# Using Data Access API with Railroad Retirement Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Railroad Retirement Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='rrb')
```
...
plt.title('Railroad Retirement Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Railroad Retirement Board Data Integration Guide](../agencies/rrb.md)
