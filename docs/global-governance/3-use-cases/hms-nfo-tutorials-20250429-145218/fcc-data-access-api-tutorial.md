# Using Data Access API with Federal Communications Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Communications Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fcc')
```
...
plt.title('Federal Communications Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Federal Communications Commission Data Integration Guide](../agencies/fcc.md)
