# Using Data Access API with Consumer Financial Protection Bureau

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Consumer Financial Protection Bureau's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='cfpb')
```
...
plt.title('Consumer Financial Protection Bureau Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Consumer Financial Protection Bureau Data Integration Guide](../agencies/cfpb.md)
