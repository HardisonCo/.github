# Using Data Access API with The Federal Reserve System

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support The Federal Reserve System's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fed')
```
...
plt.title('The Federal Reserve System Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [The Federal Reserve System Data Integration Guide](../agencies/fed.md)
