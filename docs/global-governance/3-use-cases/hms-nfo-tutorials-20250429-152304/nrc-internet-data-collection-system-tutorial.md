# Using Internet Data Collection System with Nuclear Regulatory Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Internet Data Collection System to support Nuclear Regulatory Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('internet_data_collection_system', agency='nrc')
```
