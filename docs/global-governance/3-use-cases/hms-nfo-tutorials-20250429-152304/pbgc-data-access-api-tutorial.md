# Using Data Access API with Pension Benefit Guaranty Corporation

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Pension Benefit Guaranty Corporation's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='pbgc')
```
...
plt.title('Pension Benefit Guaranty Corporation Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Pension Benefit Guaranty Corporation Data Integration Guide](../agencies/pbgc.md)
