# Using Data Access API with Selective Service Board

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Selective Service Board's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='ssb')
```
...
plt.title('Selective Service Board Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Selective Service Board Data Integration Guide](../agencies/ssb.md)
