# Using Data Access API with Central Intelligence Agency

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Central Intelligence Agency's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='cia')
```
...
plt.title('Central Intelligence Agency Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Central Intelligence Agency Data Integration Guide](../agencies/cia.md)
