# Using Data Access API with Federal Mine Safety and Health Review Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Mine Safety and Health Review Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='fmshrc')
```
...
plt.title('Federal Mine Safety and Health Review Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Federal Mine Safety and Health Review Commission Data Integration Guide](../agencies/fmshrc.md)
