# Using Data Access API with Equal Employment Opportunity Commission

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Equal Employment Opportunity Commission's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='eeoc')
```
...
plt.title('Equal Employment Opportunity Commission Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Equal Employment Opportunity Commission Data Integration Guide](../agencies/eeoc.md)
