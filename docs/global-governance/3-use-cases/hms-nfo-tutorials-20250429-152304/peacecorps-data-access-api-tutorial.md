# Using Data Access API with Peace Corps

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Peace Corps's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='peacecorps')
```
...
plt.title('Peace Corps Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
