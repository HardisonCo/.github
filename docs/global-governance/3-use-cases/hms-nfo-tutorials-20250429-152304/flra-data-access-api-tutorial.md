# Using Data Access API with Federal Labor Relations Authority

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Federal Labor Relations Authority's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='flra')
```
...
plt.title('Federal Labor Relations Authority Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Federal Labor Relations Authority Data Integration Guide](../agencies/flra.md)
