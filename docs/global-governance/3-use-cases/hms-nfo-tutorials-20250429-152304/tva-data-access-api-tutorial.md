# Using Data Access API with Tennessee Valley Authority

## Overview

This tutorial demonstrates how to use the HMS-NFO Data Access API to support Tennessee Valley Authority's mission and operations. The examples focus on practical applications of data analytics to enhance decision-making and identify opportunities.
...
component = client.get_component('data_access_api', agency='tva')
```
...
plt.title('Tennessee Valley Authority Economic Indicator Trends')
plt.xlabel('Date')
plt.ylabel('Value')
plt.grid(True)
...
- [Tennessee Valley Authority Data Integration Guide](../agencies/tva.md)
