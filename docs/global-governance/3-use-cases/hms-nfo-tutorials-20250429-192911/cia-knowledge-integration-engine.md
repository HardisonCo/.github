# Using Knowledge Integration Engine with CIA

## Overview

This tutorial demonstrates how to use HMS-NFO's Knowledge Integration Engine to enhance CIA's data capabilities and decision-making processes.
