# Using Moneyball Analytics Framework with CIA

## Overview

This tutorial demonstrates how to use HMS-NFO's Moneyball Analytics Framework to enhance CIA's data capabilities and decision-making processes.
