# Using Knowledge Integration Engine with EXIM

## Overview

This tutorial demonstrates how to use HMS-NFO's Knowledge Integration Engine to enhance EXIM's data capabilities and decision-making processes.
