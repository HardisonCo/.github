# Using Knowledge Integration Engine with SBA

## Overview

This tutorial demonstrates how to use HMS-NFO's Knowledge Integration Engine to enhance SBA's data capabilities and decision-making processes.
